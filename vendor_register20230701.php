                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-row">
                      <div class="col-md-4 mb-4">
                        ...
                        <i class="fa fa-eye" onclick="showpassword1()" aria-hidden="true"><input id="checkbo" type="checkbox" class="mx-1"></i>

                      </div>
                      <div class="col-md-4 mb-4">
                        <label for="passwd2">Confirm Password:</label>
                        <input type="password" name="passwd2" id="passwd2" class="form-control">
                        <i class="fa fa-eye" onclick="showpassword2()" aria-hidden="true"><input id="checkbo" type="checkbox" class="mx-1"></i>
                      </div>
                    </div>
          ...
          <div class="modal-body">
            ...
            <ol>
              ...
              <li>
                ...
                <br><strong>Quote Masters LLC</strong><br>
