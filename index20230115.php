        ...
        <div class="two_div_container">
            <div class="container_one_1">
                <div class="text_div_con">
                    <h2 class="upper_title">Find The Perfect Professional For You</h2>
                </div>
            ...
            <div class="container_two_2">
                <video id="vid" class="back_video_banner" autoplay muted>
                    <source src="Images/index/hero_video2.mp4" type="video/mp4">
                </video>
            </div>
            <!-- <div class="search-container">
            <div class="two_item">
            ...
            <?php //echo $GetQuotesBtn;
            ?>
            <!-- <button class="searchitem mobile" type="button" onclick="opensigninmodal()"><i class="fa fa-search" id="Btn_icon" style="font-size:24px"></i></button> -->
            <?php //echo $GetQuotesBtn2; 
            ?>
