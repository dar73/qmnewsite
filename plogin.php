...
<body class="hold-transition layout-top-nav">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row  justify-content-center">
                        <div class="col-md-6 plogin">
                            <div class="card card-info">
                                <div class="card-header border-0">
                                    <div id="LBL_INFO"></div>
                                    <div class="d-flex">
                                        <h3 class="text-left">PROVIDER LOGIN</h3>
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form class="form-horizontal" id="sp_form" action="_customer_registration.php" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="mb-1 text-center">
                                            <em><a href="forgot_password_p.php">Forgot Password?</a></em>
                                        </p>
                                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if (done != '' && done == '444') {
                $('#LBL_INFO').html(NotifyThis("Thank you for registering! Your registration has been successfully completed. To gain access to your dashboard, kindly verify your email. We've sent a confirmation email to the address you provided.", 'success'));
            } else if (done != '') {
                $('#LBL_INFO').html(NotifyThis('Invalid Email ID or Password', 'error'));
            }
