...
$appid = (isset($_POST['appid'])) ? db_input2($_POST['appid']) : '0'; //d7c9918c7c21e17qm@12340f7b6543f1
...
if ($token == 'd7c9918c7c21e17qm@12340f7b6543f1') {
    $q = "select * from appointments where 1   and iBookingID='$bid' and iApptID='$appid'  order by dDateTime DESC ";
    $r = sql_query($q);
