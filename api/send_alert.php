...
$SP_ARR = GetXArrFromYID("SELECT id,concat(email_address,' | ',First_name,'',Last_name) as spname FROM service_providers WHERE 1 and cAdmin_approval='A' and cStatus='A'", '3');
...
where  A.cService_status='P' and DATE_FORMAT(A.dDateTime,'%Y-%m-%d') >=NOW()  and A.cStatus!='X' and B.iBookingID='96'  and B.cStatus='A' and B.bverified='1' ";
    ...
    while (list($BID, $iAreaID, $date, $txtnotes) = sql_fetch_row($_r)) {
        ...
        $q2 = "SELECT service_providers_id FROM service_providers_areas WHERE zip='$zip' and service_providers_id='454' ";
        $r2 = sql_query($q2);
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="text-success">Send Lead Alert</h3>
                                </div>
                                <div class="card-body">
