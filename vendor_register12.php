...
<body class="hold-transition layout-top-nav">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-7 mb-4">
                    ...
                    <button type="button" onclick="Add_coverage();" class="btn btn-secondary">Add Coverage</button>
  ...
  <script>
    ...
    $('#city').multiselect({
      header: true,
      columns: 1,
      placeholder: 'Select Cities You Do Not Cover',
      search: true,
      selectAll: true
    });
