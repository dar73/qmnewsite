...
function Send_mail($from, $fromName, $to, $replyto, $CC_str = "", $BCC_str = "", $subject = "", $str = "", $subject_user = "", $replystr = "", $page = "", $FILES = "")
{
    ...
    $Mail->From = 'info@thequotemasters.com';
    ...
    $Mail->SMTPSecure = 'ssl';
    $Mail->SMTPAuth = true;
    $Mail->Username = 'info@thequotemasters.com';
    $Mail->Password = 'Haddock1730!!!';
    ...
    $Mail->addReplyTo('info@thequotemasters.com', 'Quote Master');
    $Mail->WordWrap = 50;
    $Mail->IsHTML(true);
    ...
    if (!empty($replystr)) {
        ...
        $AutoMail->From = 'info@thequotemasters.com';
        ...
        $AutoMail->Username = 'info@thequotemasters.com';
        $AutoMail->Password = 'Haddock1730!!!';
