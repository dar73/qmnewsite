                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-row">
                      ...
                      <hr>
                      <label for=""><span class="text-success">Note : This is not a guarantee of volume</span></label>
                      <div class="col-md-12">
                        <div class="form-group">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-7 mb-4">
                    ...
                    <div class="form-row">
                      <div class="col-10 mb-4">
                        <label for="">In the County or Counties you selected, which cities you cover?</label>
                        <div id="c_replace">
