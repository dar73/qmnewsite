              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-7 mb-4">
                    ...
                    <button type="button" onclick="Add_coverage();" class="btn btn-secondary btn-sm" id="addToCart_btn">Add Coverage</button>
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr>
                              ...
                              <td style="text-align:center;"><a href="javascript:void(0)" onclick="remove('<?php echo $key; ?>')" class="btnRemoveAction"><i class="fa fa-remove"></i></a></td>
                            </tr>
