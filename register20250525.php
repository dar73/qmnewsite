                ...
                foreach ($_SESSION[COVERAGE] as $countryKey => $states) {
                    foreach ($states as $stateKey => $value) {
                        ...
                        if (!empty($value['city'])) {
                            ...
                            sql_query("INSERT INTO coverages(iCoverageId, iproviderID,iCountryID,vStates,vCounties,vCities) VALUES ('$icoverageID','$txtspid','$countryKey','$stateKey','','" . implode(",", $value['city']) . "')");
                        } else {
                            sql_query("INSERT INTO coverages(iCoverageId, iproviderID,iCountryID,vStates,vCounties,vCities) VALUES ('$icoverageID','$txtspid','$countryKey','$stateKey','','')");
                        }
