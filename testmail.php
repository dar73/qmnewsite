...
$_q = "select distinct B.iBookingID,B.iAreaID,B.dDate
...
while (list($BID, $iAreaID, $date) = sql_fetch_row($_r)) {
    ...
    $q2 = "SELECT service_providers_id FROM service_providers_areas WHERE zip='$zip' and service_providers_id='$SPID' ";
    $r2 = sql_query($q2);
