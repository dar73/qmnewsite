                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-row">
                      <div class="form-group">
                        ...
                        <?php echo FillRadios($source, 'source', $SOURCE, '', ''); ?>
                    ...
                    <div class="form-row">
                      <div class="form-group">
                        ...
                        <?php echo FillRadios($rdISBI, 'rdISBI', $YES_ARR, '', ''); ?>
                    ...
                    <div class="form-row">
                      <div class="form-group">
                        ...
                        <?php echo FillRadios($cleaningstatus, 'cleaningstatus', $YES_ARR, '', ''); ?>
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <?php echo FillMultiCombo('', 'cmbindustrylist', 'COMBO', 'Y', $INDUSTRY_ARR, '', 'in'); ?>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <?php echo FillRadios('', 'txt_max_leadsPerMonth', $LEADS_PER_WEEK, '', ''); ?>
                        </div>
                      </div>
                  ...
                  <div class="col-lg-6 mb-6">
                    ...
                    <div class="form-row">
                      <div class="col-10 mb-4">
                        ...
                        <span id="STATE_DIV2">
                          <?php echo FillCombo2022('state2', '', array(), 'state', 'form-control mul', 'GetMultipleCounties(this.value)'); ?>
                        </span>
                      </div>
                    </div>
                    <div class="form-row">
                      <div class="col-10 mb-4">
                        <label for="">In the State you selected, which counties you cover?</label>
                        <span id="COUNTY_DIV">
                          <?php echo FillComboMultiSelect('countyid', '', array(), 'county', 'form-control mul', 'GetCities2(this.value);'); ?>
                            ...
                            foreach ($_SESSION['COVERAGE'] as $countryKey => $states) {
                              foreach ($states as $stateKey => $value) {
                                ...
                                if (isset($value['county']) && $value['county'] != '') {
                                  ...
                                  echo implode(",  ", $countyNames); // Display county names
                                }
                                echo '</td>';
                                echo '<td style="text-align:left; max-width: 50px;">';
