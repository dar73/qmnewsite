...
$data = array(
    ...
    'TRAN_NBR' => $ID,
    'TRAN_GROUP' => 'AVS',
    'REDIRECT_URL' => 'https://thequotemasters.com/paysuccess.php',
    'BATCH_ID' => $BATCH_ID
);
                            ...
                            <div class="card qmbgtheme">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- /.col -->
                                        <div class="col-md-12">
                                            <form action="https://services.epxuap.com/browserpost/" method="post" id="checkout_form">
                                                <h3 class="">Payment</h3>
                                                <div class="form-row">

                                                    <input type="hidden" id="TAC" name="TAC" value="<?php echo $tacValue; ?>">

                                                    <input type="hidden" name="TRAN_CODE" value="AVS">

                                                    <input type="hidden" name="BATCH_ID" id="BATCH_ID" value="1327">
                                                    ...
                                                    <input type="hidden" name="REDIRECT_URL" value="https://thequotemasters.com/paysuccess.php">
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label for="ccnum">Amount : 0.00 <span class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" maxlength="4" onkeypress="return numbersonly(event);" class="form-control" required id="EXP_DATE" name="EXP_DATE" placeholder="YYMM">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
