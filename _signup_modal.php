    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="customer_title">Join as a Customer</h4>
               
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <!-- Modal body -->
            <h3 class="createpass_text mb-3 text-center register_name">Registration for Customer</h3>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-12 ">
                            <div class="form-group">
                                ...
                                <i class="fa fa-eye" onclick="showpassword()" aria-hidden="true"><input id="checkbo" type="checkbox" ></i>
                                </div>
                                <small class="errormsg"></small>
                                <!-- <input type="checkbox" onclick="showpassword()">Show Password</span> -->
                            </div>
                        </div>
                    </div>
