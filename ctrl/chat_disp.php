...
$dataArr = GetDataFromCOND("chatbot_hints", $cond . " and cStatus!='X' order by id");
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($dataArr)) {
                                                ...
                                                for ($u = 0; $u < sizeof($dataArr); $u++) {
                                                    ...
                                                    $x_question = db_output($dataArr[$u]->question);
                                                    $x_reply = db_output($dataArr[$u]->reply);
                                                    $stat = $dataArr[$u]->cStatus;
                                                    $status_str = GetStatusImageString('CHATS', $stat, $x_id, true);
                                                    $url = $edit_url . '?mode=E&id=' . $x_id;
                                            ?>
                                                    <tr>
                                                        <td><?php echo $i . '.' ?></td>
                                                        <td><a href="<?php echo $url;?>"><?php echo $x_question; ?></a></td>
                                                        <td><?php echo $x_reply; ?></td>
