...
$availability = 'sp_availability.php';
...
$PLATINUM_FEE = db_output2($VP[0]->cRFeePaid);
...
if ($CUSERTYPE == 'P') {
    ...
    if ($PLATINUM_FEE != 'Y') {
        header('location:platinum_fee.php');
        exit;
    }
...
if ($mode == 'E') {
    ...
    $rdactype = db_output2($dataArr[0]->cCalendarAct);

    $STATE_ARR = GetXArrFromYID("select state_id,state_name from states where country_id='$country' ", '3');
    //SELECT `city_id`, `county_id`, `city_name`, `state_id`, `country_id` FROM `cities` WHERE 1
    $CITY_ARR = GetXArrFromYID("select city_id,city_name from cities where state_id='$state' and country_id='$country' ", '3');
    ...
    // $EARLIER_PLAN = GetXFromYID("select ");
    ...
    // if ($PLAN == 'P') {
    //     $PLATUNUM_VALUES = "vSnotes='$NOTES',vLeadPerWeek='$LEADS_WEEK' ";
...
<body class="hold-transition sidebar-mini">
                            ...
                            <div class="card qmbgtheme">
                                ...
                                <div class="card-body">
                                    ...
                                    if ($CUSERTYPE == 'P') {
                                        $calendar_URL='#';
                                        if ($rdactype == 'G') {
                                            $calendar_URL = 'authtoken.php';
                                        }else{
                                            $calendar_URL = 'msetup.php';
                                        }

                                        ?>
                                        <?php if ($PlatinumAgreement == 'Y') { ?>
                                            <span><strong style="color:#ff0000"> PLATINUM AGREEMENT</strong> <a href="platinum_agreement.php" target="_blank" rel="noopener noreferrer">Click here to view</a></span>

                                        <?php } ?>
                                        <div class="float-right">
                                            <a class="btn btn-warning mt-2" href="<?php echo $availability; ?>">Additional Parameters</a>
                                            <a class="btn btn-danger mt-2" href="void_payment.php">LINK DEBIT CARD</a>
                                            <a class="btn btn-info mt-2" href="<?php echo $calendar_URL; ?>">LINK CALENDAR</a>
                                        </div>

                                    <?php } ?>

                                    <form class="form-horizontal" action="" onsubmit="return ValidateFrom();" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" readonly class="form-control" name="email_address" value="<?php echo $email_address; ?>" placeholder="Email">
                                        ...
                                        <div class="form-group row border-top pt-3" style="display: ;">
                                            <label for="inputSkills" class="col-md-4  col-form-label">Profile Pic (160 * 160)<span style="color:#ff0000"> Max.(500 KB) PNG/JPG</span></label>
                                        ...
                                        <!-- <div class="form-row" id="PLATINUM_EXTRAA_DETAILS" style="<?php echo $PLATINUM_DETAIL_STYLE ?>">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <?php //echo FillMultiCombo($NOTES, 'cmbindustrylist', 'COMBO', 'Y', $INDUSTRY_EXC, '', 'in'); 
                                                    ?>
                                                </div>
                                            </div>
                                            <hr>
    ...
    <script>
        ...
        function ValidateFrom() {
            var err = 0;
            var ret_val = true;
            var plan = $('input[name="rdplan"]:checked').val();

            // if (plan == 'P') {
            //     var isSelected = $('#cmbindustrylist option:selected').length > 0;
            //     if ($('input[name="txt_max_leadsPerweek"]').is(':checked')) {
            //         //console.log("A radio button is checked.");
            //     } else {
            //         //console.log("No radio button is checked.");
            //         alert("Please select how many leads you want per week.");
