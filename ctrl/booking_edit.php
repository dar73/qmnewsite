...
$LEAD_QUES = GetXArrFromYID("select iQuesID,vQuestion from leads_question where iQuesID in (9,10)",'3');
$LEAD_ANS1 = GetXArrFromYID("select iAnsID,vAnswer from leads_answer where iQuesID='9'", '3');
$LEAD_ANS2 = GetXArrFromYID("select iAnsID,vAnswer from leads_answer where iQuesID='10'", '3');
$cmbans = $cmbans10= '';
...
if ($mode == 'E') {
    ...
    $txtemail2 = db_output2($CUSTOMER_DATA[0]->vEmail2);
    $txtphone = db_output2($CUSTOMER_DATA[0]->vPhone);
    $txtnotes = db_output2($dataArr[0]->vNotes);
    $cmbans = GetXFromYID("select iAnswerID from leads_answersheet where iResponseID='$txtid' and iQuesID='9' ");
    $cmbans10 = GetXFromYID("select iAnswerID from leads_answersheet where iResponseID='$txtid' and iQuesID='10' ");
    ...
    $txtemail2 = db_input2($_POST['txtemail2']);
    $txtnotes = db_input2($_POST['txtnotes']);
    $txtphone = db_input($_POST['txtphone']);
    $cmbans = db_input($_POST['cmbans']);
    $cmbans10 = db_input($_POST['cmbans10']);

    $values = "vFirstname='$txtfname',vLastname='$txtlname',vName_of_comapny='$txtnameofcompany',vAddress='$txtaddress',vPosition='$txtposition',vEmail='$txtemail',vEmail2='$txtemail2',vPhone='$txtphone' ";
    $QUERY = UpdataData('customers', $values, "iCustomerID=$CUSTOMERID");
    $values2 = "vNotes='$txtnotes'";
    $QUERY = UpdataData('booking', $values2, "iBookingID=$txtid");

    $_q1 = "update leads_answersheet set iAnswerID='$cmbans' where iResponseID='$txtid' and iQuesID='9'";
    $_r1 = sql_query($_q1);

    $_q1 = "update leads_answersheet set iAnswerID='$cmbans10' where iResponseID='$txtid' and iQuesID='10'";
    $_r1 = sql_query($_q1);
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="text-success">Lead #<?php echo $txtid; ?></h3>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo $edit_url; ?>" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="txtemail2" id="txtemail2" class="form-control" value="<?php echo $txtemail2; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12">
                                                <div class="position-relative form-group">
                                                    <label for="txtmessage" class="">Notes</label>
                                                    <textarea class="form-control" rows="3" id="txtnotes" name="txtnotes"><?php echo $txtnotes; ?></textarea>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for=""><?php echo $LEAD_QUES[9]; ?></label>
                                                    <?php echo FillCombo2022('cmbans', $cmbans, $INDUSTRY_ARR, 'Industry'); ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for=""><?php echo $LEAD_QUES[10]; ?></label>
                                                    <?php echo FillCombo2022('cmbans10', $cmbans10, $LEAD_ANS2, ''); ?>
                                                </div>
                                            </div>
                                        </div>
