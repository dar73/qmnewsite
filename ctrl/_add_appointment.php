...
//     [location] => shadsa
$APPID = $_POST['APPID'];
$IS_DISCOUNT = $_POST['IsDiscount'];
$DISCOUNT_AMT = $_POST['txtdisamt'];
$SPID = $_POST['txtspID'];
...
SendInBlueMail("Payment Ping FROM CURL", 'darshankubal1@gmail.com', $PAYMENT_STR, '', 'michael2@thequotemasters.com', '', 'michael2@thequotemasters.com');
