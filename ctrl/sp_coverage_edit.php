...
if ($mode == 'E') {
    ...
    $state = (isset($_POST['stateid'])) ? $_POST['stateid'] : '';
    $country = (isset($_POST['countryid'])) ? $_POST['countryid'] : '';
    $city = (isset($_POST['city'])) ? $_POST['city'] : '';
    $zips = (isset($_POST['zipid'])) ? $_POST['zipid'] : '';
    $txtstate = (isset($_POST['txtstate'])) ? $_POST['txtstate'] : '0';
...
<body class="hold-transition sidebar-mini">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card qmbgtheme">
                                ...
                                <div class="card-header mt-4">
                                    ...
                                    <h4>COMPANY :<?php echo $row['company_name']; ?> | <?php echo $row['First_name'] . ' ' .  $row['Last_name']; ?></h4>
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($COVERAGES_ARR)) {
                                                ...
                                                for ($u = 0; $u < sizeof($COVERAGES_ARR); $u++) {
                                                    ...
                                                    $x_county_str = '';
                                                    if (!empty($x_counties_arr) && count($x_counties_arr) > 0 && $x_counties_arr[0] !== '') {
                                                        $county_names = [];
                                                        foreach ($x_counties_arr as $county_id) {
                                                            if (isset($COUNTY_ARR[$county_id])) {
                                                                $county_names[] = $COUNTY_ARR[$county_id];
                                                            }
                                                        }
                                                        $x_county_str = implode(' , ', $county_names);
                                                    }
    ...
    <link rel="stylesheet" href="../scripts/jquery.multiselect.css">
    <script>
