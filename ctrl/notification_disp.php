...
$dataArr = GetDataFromCOND("notifications", $cond . " and cStatus!='X' order by iMessageID");
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($dataArr)) {
                                                ...
                                                for ($u = 0; $u < sizeof($dataArr); $u++) {
                                                    $i = $u + 1;
                                                    $x_id = db_output($dataArr[$u]->iMessageID);
                                                    $x_title = db_output($dataArr[$u]->vTitle);
                                                    //$x_reply = db_output($dataArr[$u]->reply);
                                                    $stat = $dataArr[$u]->cStatus;
                                                    $status_str = GetStatusImageString('NOTIFICATION', $stat, $x_id, true);
