              ...
              <div class="form-body">
				...
				<div class="form-group form-md-line-input">
                  ...
                  <div class="col-md-9">
                    ...
                    <span class="help-block">enter title</span> </div>
                </div>
				<div class="form-group form-md-line-input">
                ...
                <div class="form-group form-md-line-input">
                  ...
                  <div class="col-md-9">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter notes</span> </div>
                </div>
                <div class="form-group form-md-line-input">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter phone</span> </div>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter email</span> </div>
                </div>
                <div class="form-group form-md-line-input">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter operational email</span> </div>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter operational mobile no</span> </div>
                </div>
                <div class="form-group form-md-line-input">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter username</span> </div>
                ...
                <div class="form-group form-md-line-input">
                  ...
                  <div class="col-md-7">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter address</span> </div>
                  <div class="col-md-2">
                ...
                <div class="form-group form-md-line-input">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter location latitude</span> </div>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter location longitude</span> </div>
                </div>
                <div class="form-group form-md-line-input">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter street</span> </div>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter village</span> </div>
                </div>
                <div class="form-group form-md-line-input">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter landmark</span> </div>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter type</span> </div>
                </div>
                <div class="form-group form-md-line-input">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter GSTN code</span> </div>
                </div>
                <div class="form-group form-md-line-input">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter website</span> </div>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter facebook</span> </div>
                </div>
                <div class="form-group form-md-line-input">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter youtube</span> </div>
                ...
                <div class="form-group form-md-line-input">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter minimum order value</span> </div>
                ...
                <div class="form-group form-md-line-input">
                  ...
                  <div class="col-md-9">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter seo title</span> </div>
                </div>
                <div class="form-group form-md-line-input">
                  ...
                  <div class="col-md-9">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter seo keywords</span> </div>
                </div>
                <div class="form-group form-md-line-input">
                  ...
                  <div class="col-md-9">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter seo description</span> </div>
                </div>
				<div class="form-group form-md-line-input">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter preorder days</span> </div>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter preorder cut-off days</span> </div>
                </div>
				<div class="form-group form-md-line-input">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter minimum threshold inside delivery circle</span> </div>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-control-focus"> </div>
                    <span class="help-block">enter minimum threshold outside delivery circle</span> </div>
                </div>
...
{	 
	...
	jQuery.get("_vendor_listings.php", {mode:'onloaddisplay',v_id:<?php echo $txtid; ?>,rand:myRandom}, function(results) 	{ 
...
function AddVendorListing()
{
	...
	var myRandom=parseInt(Math.random()*99999999); 
	jQuery.get('../includes/ajax.inc.php', {response:'ADD_VENDOR_LISTINGS',v_id:<?php echo $txtid; ?>,mc_id:mc_id,ldate:ldate,lamt:lamt,hfeat:hfeat,hdate:hdate,hamt:hamt,cfeat:cfeat,cdate:cdate,camt:camt,rand:myRandom}, function(results) { 
  		ShowVendorListings();
	}).error(function(errores) { alert(errores.responseText); });
}
...
{	 
	var myRandom=parseInt(Math.random()*99999999); 
	jQuery.get("_party_vendor_delivery_location.php", {mode:'onloaddisplay',v_id:<?php echo $txtid; ?>,rand:myRandom}, function(results) 	{ 
...
function GetVendorLocality()
{
	...
	var myRandom=parseInt(Math.random()*99999999); 
	  jQuery.get("_party_vendor_location_locality.php", {mode:'onloaddisplay',delLOC:delLOC,v_id:<?php echo $txtid; ?>,rand:myRandom}, function(results) { 
...
{	 
	var myRandom=parseInt(Math.random()*99999999); 
	jQuery.get("_party_vendor_filters.php", {mode:'onloaddisplay',v_id:<?php echo $txtid; ?>,rand:myRandom}, function(results) 	{ 
...
{	 
	 var myRandom=parseInt(Math.random()*99999999); 
	 jQuery.get("_party_vendor_offdays.php", {mode:'onloaddisplay',v_id:<?php echo $txtid; ?>,rand:myRandom}, function(results) { 
...
function AddVendorOffDays()
{
	...
	var myRandom=parseInt(Math.random()*99999999); 
	jQuery.get('../includes/ajax.inc.php', {response:'ADD_PARTY_VENDOR_OFFDAY',v_id:<?php echo $txtid; ?>,oDAY:oDAY,oDATE:oDATE,oDESC:oDESC,oFROM:oFROM,oTO:oTO,rand:myRandom}, function(results) { 
  		ShowVendorOffDays();
	}).error(function(errores) { alert(errores.responseText); });
}
...
function DeleteVendorOffDay(vi_id,v_id)
{
	...
	{
		$.get(ajax_url, {response:'DELETE_PARTY_VENDOR_OFFDAY', vi_id:vi_id, v_id:v_id}, function(result)
		{
...
{	 
	 var myRandom=parseInt(Math.random()*99999999); 
	 jQuery.get("_party_vendor_contactno.php", {mode:'onloaddisplay',v_id:<?php echo $txtid; ?>,rand:myRandom}, function(results) { 
...
function AddVendorContactNo()
{
	...
	var myRandom=parseInt(Math.random()*99999999); 
	jQuery.get('../includes/ajax.inc.php', {response:'ADD_PARTY_VENDOR_CONTACTNO',v_id:<?php echo $txtid; ?>,txtcmobile:txtcmobile,rand:myRandom}, function(results) { 
  		ShowVendorContactNo();
	}).error(function(errores) { alert(errores.responseText); });
}
...
function DeleteVendorContactNo(vc_id,v_id)
{
	...
	{
		$.get(ajax_url, {response:'DELETE_PARTY_VENDOR_CONTACTNO', vc_id:vc_id, v_id:v_id}, function(result)
		{
			results = result.split('~');
			text = results[1];
			if(results[0]=='0')
...
{	 
	var myRandom=parseInt(Math.random()*99999999); 
	  jQuery.get("_party_vendor_images.php", {mode:'onloaddisplay',v_id:<?php echo $txtid; ?>,rand:myRandom}, function(results) { 
...
function DeleteVendorImage(ri_id,v_id)
{
	...
	{
		$.get(ajax_url, {response:'DELETE_PARTY_VENDOR_IMAGE', ri_id:ri_id, v_id:v_id}, function(result)
		{
			results = result.split('~');
			text = results[1];
			if(results[0]=='0')
