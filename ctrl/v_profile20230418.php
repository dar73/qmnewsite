                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row border-top">
                                            <label for="inputSkills" class="col-sm-3 col-xl-2 col-12 col-form-label">Business Licence<span class="text-muted">(PDF)</span></label>
                                            <div class="col-sm-9">
                                                <?php
                                                if (IsExistFile($vLicence_file, LICENCE_UPLOAD)) {
                                                ?>
                                                    <a href="<?php echo LICENCE_PATH . $vLicence_file ?>" class="mx-5 ">View file</a>
                                                    <button type="button" onClick="SubmitIncludeForm('<?php echo $edit_url; ?>','DELLIC','<?php echo $txtid; ?>','Licence File');" class="my-2 btn btn-danger">Remove</button>
                                                <?php
                                                } else { ?>

                                                    <input type="file" class="form-control" name="vLicence_file" id="vLicence_file">
                                                <?php  }
                                                ?>
                                            </div>
                                        </div>
                                        ...
                                        if (IsExistFile($vLicence_file, LICENCE_UPLOAD)) {
                                        ?>
                                            <div class="form-group row licence_div">
                                                <label for="inputSkills" class="col-sm-3 col-xl-2 col-12 col-form-label">Date Of Expiry</label>
                                                <div class="col-sm-9">
                                                    <input type="date" class="form-control" value="<?php echo $dDate_Licence_expiry; ?>" name="dDate_Licence_expiry" id="dDate_Licence_expiry">
                                                </div>
                                            </div>
                                        <?php } else { ?>
                                            <div class="form-group row licence_div" style="display: none;">
                                                <label for="inputSkills" class="col-sm-3 col-xl-2 col-12 col-form-label">Date Of Expiry</label>
                                                <div class="col-sm-9">
                                                    <input type="date" class="form-control" value="<?php echo $dDate_Licence_expiry; ?>" name="dDate_Licence_expiry" id="dDate_Licence_expiry">
                                                </div>
                                        ...
                                        <div class="form-group row mt-4 border-bottom" style="display: none;">
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputSkills" class="col-sm-3 col-xl-2 col-12 col-form-label">Insurance<span class="text-muted">(PDF)</span></label>
                                            <div class="col-sm-9">
                                                <?php
                                                if (IsExistFile($vInsurance_file, INSURANCE_UPLOAD)) {
                                                ?>
                                                    <a href="<?php echo INSURANCE_PATH . $vInsurance_file ?>" class="mx-5 ">View file</a>
                                                    <button type="button" onClick="SubmitIncludeForm('<?php echo $edit_url; ?>','DELINS','<?php echo $txtid; ?>','Insurance File');" class="my-2 btn btn-danger">Remove</button>
                                                <?php
                                                } else { ?>
                                                    <input type="file" class="form-control" name="vInsurance_file" id="vInsurance_file">
                                        ...
                                        ?>
                                            <div class="form-group row insurance_div">
                                                <label for="inputSkills" class="col-sm-3 col-xl-2 col-12 col-form-label">Date Of Expiry</label>
                                                <div class="col-sm-9">
                                                    <input type="date" class="form-control" value="<?php echo $dDate_insurance_expiry; ?>" name="dDate_insurance_expiry" id="dDate_insurance_expiry">
                                                </div>
                                            </div>
                                        <?php } else { ?>
                                        ...
                                        <div class="form-group row">
                                            <label for="inputSkills" class="col-sm-3 col-xl-2 col-12 col-form-label">Brochure<span class="text-muted">(PDF)</span></label>
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                ?>
                                                    <a href="<?php echo BROCHURE_PATH . $vBrochure; ?>" class="mx-5 ">View file</a>
                                                    <button type="button" onClick="SubmitIncludeForm('<?php echo $edit_url; ?>','DELBROCHURE','<?php echo $txtid; ?>','Brochure File');" class="my-2 btn btn-danger">Remove</button>
                                                <?php
                                                } else { ?>

                                                    <input type="file" class="form-control" name="vBrochure">
                                                <?php  }
                                                ?>
                                            </div>
                                        </div>
                                        <div class="form-group row mt-4 border-bottom">
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputSkills" class="col-sm-3 col-xl-2 col-12 col-form-label">Cerification<span class="text-muted">(PDF)</span></label>
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                ?>
                                                    <a href="<?php echo CERTIFICATE1_PATH . $vCertificate1 ?>" class="mx-5 ">View file</a>
                                                    <button type="button" onClick="SubmitIncludeForm('<?php echo $edit_url; ?>','DELCERTIFICATE1','<?php echo $txtid; ?>','Certificate File');" class="my-2 btn btn-danger">Remove</button>
                                                <?php
                                                } else { ?>

                                                    <input type="file" class="form-control" name="vCertificate1" value="1">
                                                <?php   }
                                                ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="inputSkills" class="col-sm-3 col-xl-2 col-12 col-form-label">Certification<span class="text-muted">(PDF)</span></label>
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                ?>
                                                    <a href="<?php echo CERTIFICATE2_PATH . $vCertificate2 ?>" class="mx-5 ">View file</a>
                                                    <button type="button" onClick="SubmitIncludeForm('<?php echo $edit_url; ?>','DELCERTIFICATE2','<?php echo $txtid; ?>','Certificate File');" class="my-2 btn btn-danger">Remove</button>
                                                <?php
                                                } else { ?>
                                                    <input type="file" class="form-control" name="vCertificate2">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputSkills" class="col-sm-3 col-xl-2 col-12 col-form-label">Awards<span class="text-muted">(PDF)</span></label>
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                ?>
                                                    <a href="<?php echo CERTIFICATE3_PATH . $vCertificate3; ?>" class="mx-5 ">View file</a>
                                                ...
                                                <?php
                                                    ...
                                                    <input type="file" class="form-control" name="vCertificate3">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="">Govt ID/Drivers License</label>
                                                    <?php
                                                    if (IsExistFile($vGovtID, GOVTID_UPLOAD)) {
                                                    ?>
                                                        <a href="<?php echo GOVTID_PATH . $vGovtID; ?>" class="mx-5 ">View file</a>
