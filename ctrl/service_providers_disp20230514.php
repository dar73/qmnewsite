...
$dataArr = GetDataFromCOND("service_providers", $cond . ' order by id');
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $x_emailVerify; ?></td>
                                                        <td style="text-align:center;"><?php echo $status_str; ?></td>
                                                        <td style="text-align:center;"><button class="btn btn-danger" onclick="DeleteUser('<?php echo $x_id; ?>');"><i class="fa fa-trash"></i></button></td>
