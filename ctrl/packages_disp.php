...
$dataArr = GetDataFromCOND("packages", $cond . ' order by iPackageID');
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($dataArr)) {
                                                for ($u = 0; $u < sizeof($dataArr); $u++) {
                                                    $i = $u + 1;
                                                    $x_id = db_output($dataArr[$u]->iPackageID);
                                                    $x_name = db_output($dataArr[$u]->vPackageName);
                                                    $x_num_of_Days = db_output($dataArr[$u]->iNum_Days);
                                                    $x_fprice = db_output($dataArr[$u]->fPrice);
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $x_num_of_Days; ?></td>
                                                        <td><?php echo $x_fprice; ?></td>
