...
if (isset($_POST['srch_mode']) && $_POST['srch_mode'] == 'SUBMIT') {
    ...
    $params = '&keyword=' . $txtkeyword . '&txtphone=' . $txtphone . '&cmbcleaningstatus=' . $cmbcleaningstatus . '&cmbplan=' . $cmbplan;
    ...
    $params2 = '?keyword=' . $txtkeyword . '&txtphone=' . $txtphone . '&cmbcleaningstatus=' . $cmbcleaningstatus . '&cmbplan=' . $cmbplan;
                                        ...
                                        <div class="app-page-title2">
                                            <div class="page-title-wrapper">
                                                <form class="form-inline p-3" name="frmSearch" id="frmSearch" action="<?php echo $disp_url; ?>" method="post">
                                                    ...
                                                    <div class="wm-100 mrm-50 position-relative form-group m-1">
                                                        <?php echo FillCombo2022('cmbplan', $cmbplan, $PLANS_ARR, 'Plan') ?>
                                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($dataArr)) {
                                                for ($u = 0; $u < sizeof($dataArr); $u++) {
                                                    ...
                                                    $timeline_url= "activity-timeline.php?id=" . $x_id;
                                            ?>
                                                    <tr>
                                                        <td><?php echo $i . '.' ?></td>
                                                        ...
                                                        <td style="text-align:center;">
                                                            ...
                                                            <?php } ?>
                                                            &nbsp;<button class="btn btn-success"><a href="<?php echo $edit_coverage_url; ?>" target="_blank" rel="noopener noreferrer"><i class='far fa-compass' style='color:#000'>&nbsp;coverage</i></a></button> &nbsp;<button class="btn btn-info"><a href="<?php echo $timeline_url; ?>" target="_blank" rel="noopener noreferrer"><i class='fas fa-plus' style='color:#000'>&nbsp;Timeline</i></a></button>
