...
$disp_url = 'sp_report2.php';
$edit_url = 'sp_edit.php';
$excel_url = 'download_rpt2.php';
...
//   `vLicence_file` text NOT NULL, 1
//   `dDate_Licence_expiry` date NOT NULL, 
//   `vInsurance_file` text NOT NULL, 2
//   `dDate_insurance_expiry` date NOT NULL,
//   `email_verify_key` text NOT NULL,
//   `email_verify` tinyint(1) NOT NULL,
//   `street` text NOT NULL,
//   `state` text NOT NULL,
//   `county` text NOT NULL,
//   `city` text NOT NULL,
//   `vBrochure` text NOT NULL, 3
//   `vCertificate1` text NOT NULL, 4
//   `vCertificate2` text NOT NULL, 
//   `vCertificate3` text NOT NULL,5
//   `vFblink` text NOT NULL, 6
//   `vInstalink` text NOT NULL, 7
//   `cStatus` char(1) NOT NULL DEFAULT 'I',
//   `vLinkedInlink` varchar(255) DEFAULT NULL, 8
//   
//   PRIMARY KEY (`id`)
// ) 
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4>List of service Providers who have not uploaded the required documents</h4>
