...
if (true) {
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if (isset($_POST["txtemail"]) && isset($_POST["txtpassword"])) // && isset($_POST["btnlogin"]))
        {
            ...
            $usertype = db_input($_POST["usertype"]);
            ...
            elseif ($email == '')
                ...
                $u_id = $u_level = 0;
                $q1 = "select iCustomerID,vFullname,vPassword from customers where vEmail='$email' "; //customers table
                $q2 = "select id,First_name,password from service_providers where email_address='$email' "; //vendor table
                if ($usertype == 2) {
                ...
                if ($ret == -1 || $ret == -2) {
                    ...
                    $URL1 = SITE_ADDRESS . "ctrl/c_profile.php";
                    $URL2 = SITE_ADDRESS . "ctrl/v_profile.php";
