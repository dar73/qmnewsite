...
<head>
	...
	<style>
		...
		.display_appo p.card-price {
			width: 50%;
		}
		a time {
			color: #212529;
		}
		.display_appo .address {
			color: #525252
		}
	</style>
</head>
							...
							<div class="card">
								<div class="card-body">
									<div class="col-12 d-flex">
										<h6>Order ID: <span>7286</span></h6>
										<p class="card-price text-right">$999</p>
									</div>
									<div class="col-12"><a class="text-primary">Pending  <time datetime="">Mon 30, 08:00 am</time></a></div>
									<div class="col-12 address mt-2"><p>68, Sanehkunj society, Isanpur, Gujrat, India 123456</p></div>
									<div class="col-12 d-flex text-center text-primary">
										<div class="col-4"><a href=""><i class="fa fa-info-circle" aria-hidden="true"></i><br>Info</a></div>
										<div class="col-4"><a href=""><i class="fa fa-calendar" aria-hidden="true"></i><br>Reschedule</a></div>
										<div class="col-4"><a href=""><i class="fa fa-times-circle" aria-hidden="true"></i><br>Cancel</a></div>
									</div>
								</div><!-- /.card-body -->
							</div>
							<!-- /.nav-tabs-custom -->
