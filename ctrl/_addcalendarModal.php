...
$MODAL_BODY .= ' <div class="form-group">
                    <input type="checkbox" id="IsDiscount" name="IsDiscount" value="Y">
                    <label for="IsDiscount">Is Discount?</label><br>
                </div>';
$MODAL_BODY .= ' <div class="form-group">
                    <label>Discount Amt <span class="text-danger">(new amount to be deducted)</span></label>
                    <input type="text" name="txtdisamt" id="txtdisamt" class="form-control" value="">
                </div>';
$MODAL_BODY .= '<div class="form-group">
                  <input type="button" class="form-control  btn-primary" onclick="InitiatePayment();"  value="Add Event" />
                </div>';
