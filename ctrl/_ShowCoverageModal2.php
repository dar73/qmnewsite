...
if ($mode == 'UPDATE_COVERAGE') {
    ...
    $SELECTED_COUNTRY = $COVERAGE_DATA[0]->iCountryID; //country from DB
    ...
    $body .=  FillCombo2022('countryid', $SELECTED_COUNTRY, $COUNTRIES, 'Country', 'form-control', 'GetStates2(this.value);','disabled');
    $body .= '</div>';

    $body .= '<div class="form-group">
                <label for="stateid">State <span class="text-danger">*</span></label><span id="STATE_DIV">';
    $body .= FillCombo2022('stateid', $SELECTED_STATE, $STATE_ARR, 'state', 'form-control', 'GetCounties2(this.value);', 'disabled');
    $body .= '</span></div>';

    // County multiselect before city
    $body .= '<div class="form-group">
    ...
    $body .= '<div class="form-group">
                <label for="stateid">State <span class="text-danger">*</span></label><span id="STATE_DIV">';
    $body .= FillCombo2022('state2', '', array(), 'state', 'form-control', 'GetCounties2(this.value);');
    $body .= '</span></div>';
